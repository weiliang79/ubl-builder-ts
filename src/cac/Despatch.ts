...
const ParamsMap: IGenericKeyValue<ParamsMapValues> = {
  ...
  requestedDespatchDate: { order: 2, attributeName: 'cbc:RequestedDespatchDate', max: 1, classRef: UdtDate },
  requestedDespatchTime: { order: 3, attributeName: 'cbc:RequestedDespatchTime', max: 1, classRef: UdtTime },
  estimatedDespatchDate: { order: 4, attributeName: 'cbc:EstimatedDespatchDate', max: 1, classRef: UdtDate },
  estimatedDespatchTime: { order: 5, attributeName: 'cbc:EstimatedDespatchTime', max: 1, classRef: UdtTime },
  actualDespatchDate: { order: 6, attributeName: 'cbc:ActualDespatchDate', max: 1, classRef: UdtDate },
  actualDespatchTime: { order: 7, attributeName: 'cbc:ActualDespatchTime', max: 1, classRef: UdtTime },
  guaranteedDespatchDate: { order: 8, attributeName: 'cbc:GuaranteedDespatchDate', max: 1, classRef: UdtDate },
  guaranteedDespatchTime: { order: 9, attributeName: 'cbc:GuaranteedDespatchTime', max: 1, classRef: UdtTime },
  releaseID: { order: 10, attributeName: 'cbc:ReleaseID', max: 1, classRef: UdtIdentifier },
  instructions: { order: 11, attributeName: 'cbc:Instructions', max: undefined, classRef: UdtText },
  despatchAddress: { order: 12, attributeName: 'cac:DespatchAddress', max: 1, classRef: () => DespatchAddress },
  despatchLocation: {
    order: 13,
    attributeName: 'cac:DespatchLocation',
    max: 1,
    classRef: () => DespatchLocation,
  },
  despatchParty: { order: 14, attributeName: 'cac:DespatchParty', max: 1, classRef: () => DespatchParty },
  carrierParty: { order: 15, attributeName: 'cac:CarrierParty', max: 1, classRef: () => CarrierParty },
  NotifyParties: { order: 16, attributeName: 'cac:NotifyParty', max: undefined, classRef: () => NotifyParty },
  contact: { order: 17, attributeName: 'cac:Contact', max: 1, classRef: () => Contact },
