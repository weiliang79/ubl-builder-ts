...
const ParamsMap: IGenericKeyValue<ParamsMapValues> = {
  ...
  minimumQuantity: { order: 3, attributeName: 'cbc:MinimumQuantity', max: 1, classRef: UdtQuantity },
  maximumQuantity: { order: 4, attributeName: 'cbc:MaximumQuantity', max: 1, classRef: UdtQuantity },
  actualDeliveryDate: { order: 5, attributeName: 'cbc:ActualDeliveryDate', max: 1, classRef: UdtDate },
  actualDeliveryTime: { order: 6, attributeName: 'cbc:ActualDeliveryTime', max: 1, classRef: UdtTime },
  latestDeliveryDate: { order: 7, attributeName: 'cbc:LatestDeliveryDate', max: 1, classRef: UdtDate },
  latestDeliveryTime: { order: 8, attributeName: 'cbc:LatestDeliveryTime', max: 1, classRef: UdtTime },
  releaseID: { order: 9, attributeName: 'cbc:ReleaseID', max: 1, classRef: UdtIdentifier },
  trackingID: { order: 10, attributeName: 'cbc:TrackingID', max: 1, classRef: UdtIdentifier },
  deliveryAddress: { order: 11, attributeName: 'cac:DeliveryAddress', max: 1, classRef: () => DeliveryAddress },
  deliveryLocation: {
    order: 12,
  ...
  carrierParty: { order: 17, attributeName: 'cac:CarrierParty', max: 1, classRef: () => CarrierParty },
  ...
  shipment: { order: 24, attributeName: 'cac:Shipment', max: 1, classRef: () => ShipmentType },
};
